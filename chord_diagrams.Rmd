...
```{r customize color and chord features}
chordDiagram(relations,
...
```{r Applying the chorddiag function to Friends matrix data}
...
```{r loading in and plotting data}
